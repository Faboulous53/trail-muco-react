...
const Popup = () => {
    const [visiblePopup, setVisiblePopup] = useState(JSON.parse(localStorage.getItem("popupVisible")) === false ? false : true);
    ...
    return (
        <div className='back-popup' id="popup">
            <div className="popup">
                ...
                <p>Il s'agit actuellement d'une version d'essai.<br/>En cours de développement.</p>
                <p>Bonne visite!</p>
